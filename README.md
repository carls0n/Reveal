...
Bypasses every attempt to conceal an LKM rootkit. Even modules hidden using kobj will be easily found. Even LKM rootkit that hide from memory scanning will be found!
